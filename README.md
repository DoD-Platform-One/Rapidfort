...
| aggregator.image.tag | string | `"1.1.207-patch-rfhardened"` |  |
...
| backend.image.tag | string | `"1.1.223-rfhardened"` |  |
...
| fileupload.image.tag | string | `"1.1.207-rfhardened"` |  |
...
| frontrow.image.tag | string | `"1.1.207-rfhardened"` |  |
...
| isomaster.image.tag | string | `"1.1.207-rfhardened"` |  |
...
| rfscan.image.tag | string | `"1.1.207-rfhardened"` |  |
...
| rfapi.image.tag | string | `"1.1.207-rfhardened"` |  |
...
| rfpubsub.image.tag | string | `"1.1.207-rfhardened"` |  |
...
| runner.image.tag | string | `"1.1.207-rfhardened"` |  |
...
| vulnsdb.image.tag | string | `"1.1.207-rfhardened"` |  |
