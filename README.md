...
| rfsupportServiceAccount.create | bool | `true` |  |
| rfsupportServiceAccount.name | string | `"rf-support-sa"` |  |
| rfsupportServiceAccount.automountServiceAccountToken | bool | `false` |  |
| rfsupportServiceAccount.annotations | object | `{}` |  |
| userOnboard.enabled | bool | `true` |  |
...
| aggregator.image.tag | string | `"1.1.422-rfhardened"` |  |
| aggregator.ports | object | `{}` |  |
| aggregator.ephemeralVolumeClaimTemplates | list | `[]` |  |
| aggregator.volumes[0].name | string | `"aggregator-data"` |  |
| aggregator.volumes[0].emptyDir.sizeLimit | string | `"29Gi"` |  |
...
| backend.image.tag | string | `"1.1.422-rfhardened"` |  |
...
| documentation.image.tag | string | `"1.1.422-rfhardened"` |  |
...
| filesredis.initContainers | list | `[]` |  |
| filesredis.podSecurityContext.fsGroup | int | `1001` |  |
| filesredis.podSecurityContext.runAsUser | int | `1001` |  |
...
| fileupload.image.tag | string | `"1.1.422-rfhardened"` |  |
...
| frontrow.image.tag | string | `"1.1.422-rfhardened"` |  |
...
| frontrow.podSecurityContext.fsGroup | int | `101` |  |
| frontrow.podSecurityContext.runAsUser | int | `101` |  |
...
| isomaster.image.tag | string | `"1.1.422-rfhardened"` |  |
...
| keycloak.podSecurityContext.runAsUser | int | `2000` |  |
...
| lockredis.initContainers | list | `[]` |  |
| lockredis.podSecurityContext.fsGroup | int | `1001` |  |
| lockredis.podSecurityContext.runAsUser | int | `1001` |  |
...
| mysql.initContainers | list | `[]` |  |
| mysql.podSecurityContext.fsGroup | int | `1001` |  |
| mysql.podSecurityContext.runAsUser | int | `1001` |  |
...
| redis.initContainers | list | `[]` |  |
| redis.podSecurityContext.fsGroup | int | `1001` |  |
| redis.podSecurityContext.runAsUser | int | `1001` |  |
...
| rfscan.image.tag | string | `"1.1.422-rfhardened"` |  |
...
| rfapi.image.tag | string | `"1.1.422-rfhardened"` |  |
...
| rfpubsub.image.tag | string | `"1.1.422-rfhardened"` |  |
...
| rfx.image.tag | string | `"1.1.422-rfhardened"` |  |
| rfx.ports[0].name | string | `"http"` |  |
| rfx.ports[0].containerPort | int | `8080` |  |
| rfx.volumes | object | `{}` |  |
| rfx.volumeMounts | object | `{}` |  |
| rfx.initContainers | object | `{}` |  |
| rfx.podSecurityContext.fsGroup | int | `101` |  |
| rfx.podSecurityContext.runAsUser | int | `101` |  |
...
| runner.image.tag | string | `"1.1.422-rfhardened"` |  |
| runnerbeat.<<.image.tag | string | `"1.1.422-rfhardened"` |  |
...
| vulnsdb.image.tag | string | `"1.1.422-rfhardened"` |  |
...
| istio.rapidfort.gateways[0] | string | `"istio-gateway/public-ingressgateway"` |  |
| istio.rapidfort.hosts[0] | string | `"rapidfort.{{ .Values.domain }}"` |  |
| networkPolicies.enabled | bool | `true` |  |
| networkPolicies.ingress.namespaceLabels."app.kubernetes.io/name" | string | `"istio-gateway"` |  |
| networkPolicies.ingressLabels.app | string | `"public-ingressgateway"` |  |
| networkPolicies.ingressLabels.istio | string | `"ingressgateway"` |  |
| networkPolicies.egress.namespaceLabels."app.kubernetes.io/name" | string | `"istio-gateway"` |  |
